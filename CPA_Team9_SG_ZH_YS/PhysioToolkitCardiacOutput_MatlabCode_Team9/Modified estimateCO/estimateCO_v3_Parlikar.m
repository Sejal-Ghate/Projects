function [co, to, told, fea, taus_tpr] = estimateCO_v3_Parlikar(t_on,feat,beatq,estID,filt_order)
...
%     end
 ...
 %       case 11,   x = est11_mf(abp,onset1,MAP,HR,age,gender);
        ...
        case 14,   [x, full_taus] = est14_Parlikar(MAP,Period,Pdias,PP);
        otherwise, x = nan;
    end
...
%    sqi1   = sqi{seg}(:,1);
    ...
    if filt_order<2, tau_filt = full_taus;
    else             tau_filt = filtfilt(ones(filt_order,1)/filt_order,1,full_taus);
    end
